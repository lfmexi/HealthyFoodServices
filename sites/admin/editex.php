...
<body>
    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="forming.php">Editar ingredientes</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="formex.php">Editar Ejercicios</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Crear Ejercicio</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
								<?php
								if (!isset($_POST['name'])&&!isset($_POST['obj'])&&!isset($_POST['video'])&&isset($_POST['id'])){
								...
								$result1 = mysql_query($query);
                                    ...
                                    echo '        <input class="form-control" name="name" value="'.$row["nombre"].'">';
                                    echo '    </div>';
                                    echo '    <div class="form-group">';
                                    echo '        <label>Video:</label>';
                                    echo '        <input class="form-control" name="video" value="'.$row["idVideo"].'">';
                                    echo '    </div>';
                                    echo '        <input type="hidden" name="id" value="'.$id.'">';
                                    echo '    <div class="form-group">';
                                    echo '    <label>Objetivo</label>';
                                    echo '    <select class="form-control" name="obj">';
                                    echo '      <option value="Bajar peso">Bajar peso</option>';
                                    echo '      <option value="Mantener peso">Mantener peso</option>';
                                    echo '      <option value="Ganar peso">Ganar peso</option>';
                                    echo '    </select>';
                                    echo '    </div>';
								...
								}else if (isset($_POST['name'])&&isset($_POST['obj'])&&isset($_POST['video'])&&isset($_POST['id'])){
                                                                $conn = mysql_connect("mysql.hostinger.es","u147283082_admin" ,"seminario2");
								mysql_selectdb("u147283082_hlife", $conn);
								$name=$_POST['name'];
								$vid=$_POST['video'];
								$obj=$_POST['obj'];
								$id=$_POST['id'];
								$query = "UPDATE Ejercicio SET nombre='".$name."', objetivo='".$obj."', idVideo='".$vid."' WHERE idEjercicio=".$id.";";
								//mysql_query("BEGIN");
								$result1 = mysql_query($query);
								if (!$result1){
									echo "El ejercicio no fue actualizado";
								}else{
									echo "El ejercicio fue actualizado con éxito";
								}
								//mysql_query("COMMIT");	
								mysql_close($conn);
								}
