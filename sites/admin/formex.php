                        ...
                        <div class="panel-body">
                            <div class="row">
								...
								if (!isset($_POST['name'])&&!isset($_POST['cal'])){
                                    ...
                                    echo '        <input class="form-control" name="video" placeholder="">';
                                    echo '    </div>';
                                    echo '    <div class="form-group">';
								...
								$vid=$_POST['video'];
								$obj=$_POST['obj'];
								$query = "INSERT INTO Ejercicio (nombre, objetivo, idVideo) VALUES ('".$name."','".$obj."','".$vid."');";
								//mysql_query("BEGIN");
								$result1 = mysql_query($query);
								if (!$result1){
									echo "El ejercicio no fue ingresado";
								}else{
									echo "El ejercicio fue ingresado con éxito";
								}
								//mysql_query("COMMIT");	
								mysql_close($conn);
								}
