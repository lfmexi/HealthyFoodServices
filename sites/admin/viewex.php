        ...
        <div id="page-wrapper">
           ...
           <div class="row">
                <div class="col-lg-12">
					...
					$query = "SELECT idEjercicio, Nombre, objetivo, idVideo FROM Ejercicio;";
					//mysql_query("BEGIN");
					...
					echo '<tr class="gradeA">';
                                        echo '    <td>'.$r['Nombre'].'</td>';
                                        echo '    <td class="center">'.$r['objetivo'].'</td>';
                                        echo '    <td>'.$r['idVideo'].'</td>';
                                        echo '    <td>';
                                        echo '<form method="POST" action="editex.php">';
                                        echo '<input type="hidden" name="id" value="'.$r['idEjercicio'].'">';
